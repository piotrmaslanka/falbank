...
//! @return An object (a class instance)
  ...
  $this->DisplayPreferences('');
	...
	$this->addFont('timespl','I','timespli.php');
	$this->addFont('timespl','B','timesplbd.php');
//	$this->addFont('timespl','','timespl.php');
	
	$this->SetFont('timespl','',11); // Changeable?(not yet...)
  ...
  $this->row=-1; 
	...
	$this->fontlist=array("arial","times","courier","helvetica","symbol","monospace","serif","sans","timespl");
...
//! @desc The footer is printed in every page!
    ...
    $this->SetFont('timespl','B',9);
  	$this->SetTextColor(0);
    //Arial italic 9
    $this->SetFont('timespl','I',9);
    //Page number
    $this->Cell(0,10,$this->PageNo().'/{nb}',0,0,'C');
    //Return Font to normal
    $this->SetFont('timespl','',11);
}
...
//! @desc Prepares buffered text to be printed with FlowingBlock()
    ...
    for($i=0;$i < $array_size; $i++)
    {
      ...
      if(isset($vetor[4]) and $vetor[4] != '') $this->SetFont('timespl');
